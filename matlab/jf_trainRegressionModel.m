function [trainedModel, validationRMSE] =...
    jf_trainRegressionModel(trainingData, predictorNames,...
    responseNames, Nkfold)
...
% Auto-generated by MATLAB on 09-Nov-2018 10:37:51
...
response = inputTable.(responseNames);
...
trainedModel.RequiredVariables = {'gauge_lat', 'gauge_lon'};
...
inputTable = trainingData;
predictors = inputTable(:, predictorNames);
response = inputTable.q_mean;
isCategoricalPredictor = [false, false];

% Perform cross-validation
partitionedModel = crossval(trainedModel.RegressionGP, 'KFold', Nkfold);
